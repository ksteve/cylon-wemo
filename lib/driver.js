...
Driver.prototype.setPowerState = function(opts) {
	console.log("[ joulie-cylon ] - wemo - set_power_state");
	var self = this;
...
Driver.prototype.getPowerState = function(opts) {
	console.log("[ joulie-cylon ] - wemo - get_power_state");
	var self = this;
	return new Promise(function(resolve, reject){
		self.connection.getBinaryState(function(err, mState){
			if(err){
				reject(err);
			}
			resolve({state : mState})
		});
...
Driver.prototype.getConsumption = function(){
	console.log("[ joulie-cylon ] - wemo - get_consumption");
	var self = this;
	return new Promise(function(resolve,reject){
